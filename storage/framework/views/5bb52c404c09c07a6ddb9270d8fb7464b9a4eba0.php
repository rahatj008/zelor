<section class="pt-80" style="background:#404040;">
    <div class="Container">
        <div class="section-title">
            <div class="section-title-left">
                <div class="title-left-content">
                    <h3 style="color: white;"><?php echo e(@frontend_section_data($best_selling_section->value,'heading')); ?> </h3>
                    <p style="color: white;"><?php echo e(@frontend_section_data($best_selling_section->value,'sub_heading')); ?></p>
                </div>
            </div>
            <div class="section-title-right">
                <a href="<?php echo e(route('best.product')); ?>" style="color: white !important;border: 0.1rem solid white !important;" class="view-more-btn">
        ...
        <div class="best-selling-items">
            ...
            <div class="row g-4">
                <?php $__empty_1 = true; $__currentLoopData = $best_selling_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-xl-4 col-md-6">
                        <div class="best-selling-item">
                            <div class="product-img">
                                ...
                                <span class="offer-tag">-<?php echo e(round($product->discount_percentage)); ?> %</span>
                                <?php endif; ?>
                            ...
                            <div class="product-info">
                                ...
                                <h4 class="product-title">
                                    <a href="<?php echo e(route('product.details',[$product->slug ? $product->slug : make_slug($product->name),$product->id])); ?>"><?php echo e($product->name); ?></a>
                                </h4>
...
<?php if( @frontend_section_data($promo_banner->value,'position') == 'best-selling-products'): ?>
...
<?php if( @frontend_section_data($promo_second_banner->value,'position') == 'best-selling-products'): ?>
...
<?php endif; ?>
<?php /**PATH /home/u935716083/domains/testlinkdesigns.com/public_html/zelor/resources/views/frontend/section/best_selling_product.blade.php ENDPATH**/ ?>
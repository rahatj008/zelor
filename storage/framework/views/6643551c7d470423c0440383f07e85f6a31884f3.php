<script>
    ...
    $('.quick--view--product').on('click', function (){
        ...
        $.ajax({
            url: "<?php echo e(route('quick.view.item')); ?>",
            method: "GET",
            data: {
                id:productId,
                slug:slug,
    ...
    $(document).on('click', '.wishlistitem', function (e){
        ...
        var login =  <?php echo e(auth()->check() ? 'true' : 'false'); ?>;
        var productId = $(this).attr('data-product_id');

            var $element = $(this);
            $.ajax({
                type:"GET",
                url:"<?php echo e(route('user.wish.item.store')); ?>",
                data:{
    ...
    $(document).on('click', '.apply-btn', function(){
        ...
        $.ajax({
            url: "<?php echo e(route('user.apply.coupon')); ?>",
            method:"POST",
            beforeSend: function() {
            ...
            data:{ _token:"<?php echo e(csrf_token()); ?>",code:code,subtotal:subtotal},
            success: function(response){
                if(response.success) {
                    ...
                    switch("<?php echo e(site_settings('currency_position',App\Enums\StatusEnum::true->status())); ?>"){
                        case "<?php echo e(App\Enums\StatusEnum::true->status()); ?>":
                            totalcartamount = "<?php echo e(show_currency()); ?>"+totalcartamount;
                            break;
                        case "<?php echo e(App\Enums\StatusEnum::false->status()); ?>":
                           totalcartamount = totalcartamount+"<?php echo e(show_currency()); ?>";
                            break;
    ...
    $('input[type=radio][name=shipping_method]').on('change', function(){
        ...
        switch("<?php echo e(site_settings('currency_position',App\Enums\StatusEnum::true->status())); ?>"){
            case "<?php echo e(App\Enums\StatusEnum::true->status()); ?>":
                aftertotalamount = "<?php echo e(show_currency()); ?>"+aftertotalamount;
                break;
            case "<?php echo e(App\Enums\StatusEnum::false->status()); ?>":
                aftertotalamount = aftertotalamount+"<?php echo e(show_currency()); ?>";
                break;
    ...
    function getCartItemData() {
        $.ajax({
            url: "<?php echo e(route('cart.data.get')); ?>",
            method: "GET",
            beforeSend: function() {
    ...
    function totalCartItem() {
        $.ajax({
            url: "<?php echo e(route('cart.total.item')); ?>",
            method: "GET",
            success: function (response) {
    ...
    function totalCartAmount() {
        $.ajax({
            url: "<?php echo e(route('cart.total.amount')); ?>",
            method: "GET",
            success: function (response) {
                var res = "<?php echo e(show_currency()); ?>"+response
    ...
    function wishlistItemCount() {
        $.ajax({
            url: "<?php echo e(route('wish.total.item')); ?>",
            method: "GET",
            success: function (response) {
                if(response!=0){
    ...
    function compareItemCount() {
        $.ajax({
            url: "<?php echo e(route('compare.total.item')); ?>",
            method: "GET",
            success: function (response) {
                if(response!=0){
                ...
                success: function(response){
                    ...
                    if(!response.success){
                        ...
                        <div class="text-center no-products">
                                <div class="icon">
                                        <img src=<?php echo e(asset('assets/images/emptyData.png')); ?> alt="Empty Data">
                                </div>
                ...
                setTimeout(() => {
                    ...
                    if (response.success){
                        ...
                        if( checkout && checkout == 'yes'){
                            window.location.href = '<?php echo e(route("user.checkout")); ?>'; 
                        }else{
                            toaster(response.success,'success')
                        }
...
<?php /**PATH /home/u935716083/domains/testlinkdesigns.com/public_html/zelor/resources/views/frontend/partials/script.blade.php ENDPATH**/ ?>
...
?>
    ...
    <div class="breadcrumb-banner">
        <div class="breadcrumb-banner-img">
            <img src="<?php echo e(show_image(file_path()['frontend']['path'] . '/' . @frontend_section_data($breadcrumb->value, 'image'), @frontend_section_data($breadcrumb->value, 'image', 'size'))); ?>"
                alt="breadcrumb.jpg">
        </div>
                            ...
                            <div class="card-body checkout-tab">
                                <div class="step-arrow-nav">
                                    <ul class="nav nav-pills nav-justified custom-nav" role="tablist">
                                        ...
                                        <?php if(@$shippingConfiguration->shipping_option == "CARRIER_SPECIFIC"): ?>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link p-3 wave-btn shipping-tab" id="pills-bill-address-tab"
                                                    ...
                                                    <?php echo e(translate('Shipping Info')); ?>
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link p-3 wave-btn <?php if(@$shippingConfiguration->shipping_option == "LOCATION_BASED" && auth()->user()): ?>

                                                        fetch-city-shipping

                                                    <?php endif; ?>" id="pills-payment-tab"
                                                ...
                                                <?php echo e(translate('Payment Info')); ?>
                                ...
                                <div class="tab-content checkout-form-content">
                                    ...
                                    <div class="tab-pane fade show active" id="pills-bill-info" role="tabpanel"
                                        ...
                                        <div class="tab-header">
                                            ...
                                            <p class="text-muted">
                                                <?php echo e(translate('Please fill all information below')); ?>
                                        ...
                                        <div>
                                            ...
                                            <?php if(auth()->user()): ?>
                                                ...
                                                <div class="shipping-address">
                                                    <div class="row g-4">
                                                        ...
                                                        <?php if(auth()->user()->billingAddress): ?>
                                                            <?php $__currentLoopData = auth()->user()->billingAddress; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div class="col-xl-6">
                                                                    <div class="address-card">
                                                                        <div class="form-check card-radio">
                                                                            <input id="<?php echo e($loop->index); ?>-address"
                                                                                type="radio"
                                                                            ...
                                                                            <label class="form-check-label pointer"
                                                                                for="<?php echo e($loop->index); ?>-address">
                                                                                ...
                                                                                <span
                                                                                    ...
                                                                                    <span class="address-item">
                                                                                        ...
                                                                                        <small>
                                                                                            <?php echo e($address->address->address); ?>
                                                                        ...
                                                                        <div class="address-actions">
                                                                            <a href="<?php echo e(route('user.address.delete', $address->id)); ?>"
                                                                            ...
                                                                            <a href="javascript:void(0)"
                                                                                address-id="<?php echo e($address->id); ?>"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control user-info"
                                                                ...
                                                                value="<?php echo e(old('first_name') ? old('first_name') : @$user->name); ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control user-info"
                                                                ...
                                                                placeholder="<?php echo e(translate('Enter last name')); ?>"
                                                                value="<?php echo e(old('phone') ? old('phone') : @$user->last_name); ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div>
                                                            ...
                                                            <input type="email" name="email"
                                                                ...
                                                                value="<?php echo e(@$user->email ? $user->email : old('email')); ?>"
                                                    ...
                                                    <div class="col-12">
                                                        <div>
                                                            ...
                                                            <textarea name="address" class="form-control user-info address" id="billinginfo-address" placeholder="Enter address"
                                                                rows="3"><?php echo e(old('address') ? old('address') : @$user->address->address); ?></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div>
                                                            <label for="billinginfo-country_id" class="form-label">
                                                                <?php echo e(translate('Country')); ?> <span
                                                            ...
                                                            <select class="form-control guest-location country guest-country"
                                                                ...
                                                                <option value="">
                                                                    <?php echo e(translate('Select country')); ?>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div>
                                                            <label for="billinginfo-state_id" class="form-label">
                                                                <?php echo e(translate('State')); ?> <span
                                                                    class="text-danger">*</span>
                                                            </label>
                                                            ...
                                                            <select class="form-control guest-location state"
                                                                ...
                                                                <option value=""><?php echo e(translate('Select State')); ?>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div>
                                                            ...
                                                            <select class="form-control guest-location city city-base-shipping"
                                                                ...
                                                                <option value=""><?php echo e(translate('Select City')); ?>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div>
                                                            <label for="billinginfo-zip" class="form-label">
                                                                <?php echo e(translate('Zip Code')); ?> <span
                                                                    class="text-danger">*</span>
                                                            </label>
                                                            <input class="form-control user-info" type="text"
                                                                id="billinginfo-zip" name="zip"
                                                                value="<?php echo e(old('zip') ? old('zip') : @$user->address->zip); ?>"
                                                                placeholder="<?php echo e(translate('1205')); ?>" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row g-4">
                                                        <div class="col-xl-6">
                                                            <div>
                                                                <label for="billinginfo-latitude" class="form-label">
                                                                    <?php echo e(translate('Latitude')); ?> <span
                                                                        class="text-danger">*</span>
                                                                </label>
                                                        ...
                                                        <div class="col-xl-6">
                                                            <div>
                                                                <label for="billinginfo-longitude" class="form-label">
                                                                    <?php echo e(translate('Longitude')); ?> <span
                                                                        class="text-danger">*</span>
                                                                </label>
                                                        ...
                                                        <div class="col-12">
                                                            <input id="mar-search-guest"
                                                                ...
                                                                placeholder="<?php echo e(translate('Search your location here')); ?>">
                                                            <div id="gmap-guest"
                                            ...
                                            <div
                                                class="d-flex align-items-center <?php if(!auth()->user()): ?> justify-content-sm-between justify-content-start <?php else: ?> justify-content-end <?php endif; ?> flex-wrap gap-4 mt-5">

                                                <?php if(!auth()->user()): ?>
                                                    <div class="d-flex align-items-center gap-2">

                                                        <input type="checkbox" name="create_account"
                                                            value="<?php echo e(App\Enums\StatusEnum::true->status()); ?>"
                                                            class="custom-checkbox" id="create_account">
                                                        <label for="create_account">
                                                            <?php echo e(translate('Register with the provided information')); ?>
                                                ...
                                                <?php if(@$shippingConfiguration->shipping_option == "CARRIER_SPECIFIC"): ?>
                                                    <button type="button" class="nexttab check-input btn-label shipping-tab wave-btn"
                                                        ...
                                                        <?php echo e(translate('Proceed to Shipping')); ?>

                                                    </button>

                                                <?php else: ?>
                                                    <button type="button" class="btn-label nexttab shiping-input <?php if(@$shippingConfiguration->shipping_option == "LOCATION_BASED" && auth()->user()): ?>
                                                    ...
                                                    "
                                                        ...
                                                        <?php echo e(translate('Continue to Payment')); ?>
                                    ...
                                    <?php if(@$shippingConfiguration->shipping_option == "CARRIER_SPECIFIC"): ?>
                                        ...
                                        <div class="tab-pane fade" id="pills-bill-address" role="tabpanel"
                                            ...
                                            <div class="tab-header">
                                                <h5>
                                                    <?php echo e(translate('Shipping Method')); ?>
                                            ...
                                            <div class="mt-4">
                                                <div class="row g-4 shipping-configuration-section">
                                                    <?php echo $__env->make('frontend.partials.shipping_configuration', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <button type="button" class="btn-label previestab"
                                                    ...
                                                    <?php echo e(translate('Back to Personal Info')); ?>
                                    ...
                                    <div class="tab-pane fade" id="pills-payment" role="tabpanel"
                                        ...
                                        <?php if(auth_user('web') && 
                                           site_settings('customer_wallet') == App\Enums\StatusEnum::true->status() ): ?>
                                            ...
                                            <div class="tab-header">
                                                <h5>
                                                    <?php echo e(translate('Payment Type')); ?>

                                                </h5>

                                                <p class="text-muted">
                                                    <?php echo e(translate('Please select A Payment Type')); ?>
                                                ...
                                                <div class=" col-md-6">
                                                    <div class="form-check card-radio">
                                                        <input type="radio" id="Traditional"
                                                            name="wallet_payment" checked  value="<?php echo e(App\Enums\StatusEnum::false->status()); ?>"
                                                        ...
                                                        <label class="form-check-label pointer"
                                                            ...
                                                            <span class="d-flex align-items-center gap-4">
                                                                ...
                                                                <span class="fs-14 text-wrap">
                                                                    <?php echo e(translate('Traditional')); ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-check card-radio">
                                                        <input type="radio" id="wallet_payment"
                                                            name="wallet_payment" value="<?php echo e(App\Enums\StatusEnum::true->status()); ?>"
                                                            class="form-check-input payment-radio-btn payment-type">
                                                        <label class="form-check-label pointer"
                                                            for="wallet_payment">
                                                            <span class="d-flex align-items-center gap-4">
                                        ...
                                        <div id="paymentSelection"  <?php if(auth_user('web') &&  site_settings('customer_wallet') == App\Enums\StatusEnum::true->status()): ?> class="d-none mt-4"   <?php endif; ?>  >
                                            <div class="tab-header">
                                                <h5>
                                                    <?php echo e(translate('Payment Selection')); ?>

                                                </h5>
    
                                                <p class="text-muted">
                                                    <?php echo e(translate('Please select A Payment Method')); ?>

                                                </p>
                                            </div>
    
    
                                            <?php if(site_settings('cash_on_delivery', App\Enums\StatusEnum::false->status()) == App\Enums\StatusEnum::true->status()): ?>
                                                <div class="mb-5">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-check card-radio">
                                                                <input id="cod" type="radio" name="payment_id"
                                                                    value="<?php echo e(App\Enums\StatusEnum::false->status()); ?>"
                                                                    class="form-check-input">
                                                                <label class="form-check-label" for="cod">
                                                                    <span class="d-flex align-items-center gap-4">
                                                                        <span class="payment_icon">
                                                                            <img src="<?php echo e(asset('assets/images/frontend/payment/cod.jpg')); ?>"
                                                                                alt="cod.jpg">
                                                                        </span>
                                            ...
                                            <?php if(site_settings('digital_payment', App\Enums\StatusEnum::false->status()) == App\Enums\StatusEnum::true->status()): ?>
                                                <div class="tab-header">
                                                    <h5>
                                                ...
                                                <div class="row g-4">
                                                    <?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paymentMethod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="col-xl-4 col-md-6">
                                                            <div class="form-check card-radio">
                                                                <input type="radio" id="payment-<?php echo e($paymentMethod->id); ?>"
                                                                    name="payment_id" value="<?php echo e($paymentMethod->id); ?>"
                                                                    class="form-check-input payment-radio-btn">
                                                                <label class="form-check-label pointer"
                                                                    for="payment-<?php echo e($paymentMethod->id); ?>">
                                                                    <span class="d-flex align-items-center gap-4">
                                                                        <span class="payment_icon">
                                                                            <img src="<?php echo e(show_image(file_path()['payment_method']['path'] . '/' . $paymentMethod->image, file_path()['payment_method']['size'])); ?>"
                                                                                alt="<?php echo e($paymentMethod->image); ?>">
                                                                        </span>
                                            ...
                                            <?php if(site_settings('offline_payment', App\Enums\StatusEnum::false->status()) == App\Enums\StatusEnum::true->status()): ?>
                                                <div class="tab-header mt-5">
                                                    <h5>
                                                        <?php echo e(translate('Manual Payment')); ?>

                                                    </h5>
                                                </div>
                                                <div class="row g-4">
                                                    <?php $__currentLoopData = $manualPaymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manualPaymentMethod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="col-xl-4 col-md-6">
                                                            <div class="form-check card-radio">
                                                                <input type="radio"
                                                                    id="payment-<?php echo e($manualPaymentMethod->id); ?>"
                                                                    name="payment_id" value="<?php echo e($manualPaymentMethod->id); ?>"
                                                                    class="form-check-input payment-radio-btn">
                                                                <label class="form-check-label pointer"
                                                                    for="payment-<?php echo e($manualPaymentMethod->id); ?>">
                                                                    <span class="d-flex align-items-center gap-4">
                                                                        <span class="payment_icon">
                                                                            <img src="<?php echo e(show_image(file_path()['payment_method']['path'] . '/' . $manualPaymentMethod->image, file_path()['payment_method']['size'])); ?>"
                                                                                alt="<?php echo e($manualPaymentMethod->image); ?>">
                                                                        </span>
    
                                                                        <span class="fs-14 text-wrap">
                                                                            <?php echo e($manualPaymentMethod->name); ?>
                                        ...
                                        <div
                                            ...
                                            <button type="button" class="btn-label previestab"
                                                 ...
                                                 ?>
                                                data-previous="<?php echo e($dataPreviousAttribute); ?>"  ><i
                                                    class="fa-solid fa-arrow-left label-icon align-middle fs-14"></i>
                                                    <?php if(@$shippingConfiguration->shipping_option == "CARRIER_SPECIFIC"): ?>
                                                              <?php echo e(translate('Back to Shipping')); ?>
                    ...
                    <div class="col-xxl-4 col-xl-5 col-lg-4">
                        <div class="card checkout-product">
                            ...
                            <div class="card-body order-summary">
                                 ...
                                 <?php echo $__env->make('frontend.partials.order_summary', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            <?php echo e(translate('Create  Address')); ?>
                                ...
                                <div class="col-md-12">
                                    <div>
                                        <label for="add-address_name" class="form-label">
                                            <?php echo e(translate('Address Name')); ?> <span class="text-danger">*</span>
                                        </label>

                                        <input required type="text" class="form-control" id="add-address_name" name="address_name"
                                            placeholder="<?php echo e(translate('Enter name')); ?>" value="<?php echo e(old('address_name')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        <input required type="text" class="form-control " id="add-billinginfo-firstName"
                                            name="first_name" placeholder="<?php echo e(translate('Enter first name')); ?>"
                                            value="<?php echo e(old('first_name') ? old('first_name') : @$user->name); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        <input required type="text" class="form-control " id="add-billinginfo-lastName"
                                            name="last_name" placeholder="<?php echo e(translate('Enter last name')); ?>"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div>
                                        ...
                                        <select required class="form-control user-location country" name="country_id"
                                            ...
                                            <option disabled selected value=""><?php echo e(translate('Select a country')); ?></option>
                                            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($country->id); ?>">
                                                    <?php echo e($country->name); ?>
                                ...
                                <div class="col-md-4">
                                    <div>
                                        <label for="add-billinginfo-state_id" class="form-label">
                                            <?php echo e(translate('State')); ?> <span class="text-danger">*</span>
                                        </label>
                                ...
                                <div class="col-md-4">
                                    <div>
                                        <label for="add-billinginfo-zip" class="form-label">
                                            <?php echo e(translate('Zip Code')); ?> <span class="text-danger">*</span>
                                        </label>
        ...
        <div class="modal fade" id="updateAddress" tabindex="-1" data-bs-backdrop="static" aria-labelledby="updateAddress"
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            <?php echo e(translate('Update Billing Address')); ?>
...
<?php $__env->startPush('scriptpush'); ?>
    <script
        src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(site_settings('gmap_client_key')); ?>&libraries=places&v=3.49"
        defer></script>
    ...
    <script>
        ...
        <?php if(auth_user('web') && site_settings('customer_wallet') == App\Enums\StatusEnum::true->status() ): ?>
        ...
        function handleCountryChange() {
            ...
            $('.country').change(function() {
                ...
                stateDropdown.empty().append('<option value=""><?php echo e(translate('Select State')); ?></option>');
                cityDropdown.empty().append('<option value=""><?php echo e(translate('Select City')); ?></option>');
        ...
        <?php if(@$shippingConfiguration->shipping_option == "CARRIER_SPECIFIC"): ?>
            $(document).on('click', ".shipping-tab", function(e) {
                    ...
                    $.ajax({
                                ...
                                url: "<?php echo e(route('fetch.shipping.carrier')); ?>",
                                method: "POST",
            ...
            $(document).on('click', ".shipping-method", function(e) {
                ...
                if(id){
                        ...
                        $.ajax({
                            headers: {"X-CSRF-TOKEN": "<?php echo e(csrf_token()); ?>",},
                            url: "<?php echo e(route('get.shipping.method')); ?>",
        ...
        <?php if(@$shippingConfiguration->shipping_option == "LOCATION_BASED"): ?>
            ...
            function fetchShippingViaCity(id ,address_id){
                ...
                if(id ||address_id ){
                        ...
                        $.ajax({
                            headers: {"X-CSRF-TOKEN": "<?php echo e(csrf_token()); ?>",},
                            url: "<?php echo e(route('fetch.shipping.city')); ?>",
        ...
        $(document).on('click', ".edit-address", function(e) {
            ...
            $.ajax({
                url: '<?php echo e(route('user.address.edit')); ?>',
                type: 'POST',
                beforeSend: function() {
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u935716083/domains/testlinkdesigns.com/public_html/zelor/resources/views/frontend/checkout.blade.php ENDPATH**/ ?>
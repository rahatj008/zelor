<?php if($flashDeal): ?>
    <section class="bg--primary pt-80 pb-80" style="background:#404040;">
        <div class="Container">
            <div class="row g-4">
                <div class="col-xl-3 col-lg-4 col-md-5">
                    <div class="deal-title-area">
                        <div class="title-left-content mb-5">
                            <h3>
                                <?php echo e($flashDeal->name); ?>

                                <span><?php echo e(@frontend_section_data($flash_deal->value,'heading')); ?></span> </h3>
                            <p><?php echo e(@frontend_section_data($flash_deal->value,'sub_heading')); ?></p>
                        </div>
                        <p class="time-remaining">
                            <?php echo e(translate('Time Remaining')); ?>
                        ...
                        <a href="<?php echo e(route('flash.deal',$flashDeal->slug)); ?>" class="view-more-btn d-inline-flex"><?php echo e(translate('View More Products')); ?> </a>
                    </div>
                </div>
...
<?php /**PATH /home/u935716083/domains/testlinkdesigns.com/public_html/zelor/resources/views/frontend/section/flash_deal.blade.php ENDPATH**/ ?>
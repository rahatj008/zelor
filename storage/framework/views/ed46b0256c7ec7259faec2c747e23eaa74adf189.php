...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
     <?php echo $__env->make('frontend.partials.seo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <link href="<?php echo e(asset('assets/frontend/css/bootstrap.min.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('assets/global/css/select2.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('assets/frontend/css/select2.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('assets/frontend/css/swiper-bundle.min.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('assets/frontend/css/all.min.css')); ?>" rel="stylesheet" type="text/css" />

    <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/line-awesome.min.css')); ?>" />

    <link href="<?php echo e(asset('assets/frontend/css/nouislider.min.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('assets/frontend/css/global.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('assets/frontend/css/custom.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('assets/frontend/css/view-ticket.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('assets/frontend/css/bootstrap-custom.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('assets/frontend/css/new_style.css')); ?>" rel="stylesheet" type="text/css">
    ...
    <link href="<?php echo e(asset('assets/frontend/css/media.css')); ?>" rel="stylesheet" type="text/css">
    ...
    <?php if(site_settings("google_analytics") == App\Enums\StatusEnum::true->status() ): ?>
       <script async src="https://www.googletagmanager.com/gtag/js?id=<?php echo e(site_settings('google_tracking_id')); ?>"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());
          gtag('config', '<?php echo e(site_settings("google_tracking_id")); ?>');
        </script>
    <?php endif; ?>


    <?php if(site_settings('facebook_pixel') == App\Enums\StatusEnum::true->status()): ?>
        ...
        <script>
            ...
            fbq('init', '<?php echo e(site_settings("facebook_pixel_id")); ?>');
            fbq('track', 'PageView');
        </script>
        <noscript>
            <img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=<?php echo e(site_settings("facebook_pixel_id")); ?>&ev=PageView&noscript=1"/>
        </noscript>

   <?php endif; ?>


    <?php echo $__env->make('frontend.partials.color', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <style>
        ...
        .newsletter {
            ...
            background: linear-gradient(45deg, rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.6)),
                url("<?php echo e(asset('assets/images/news_latter.jpg')); ?>");
            z-index: 1;
        ...
        .login-bg{
            ...
            z-index: 2 !important;
           background: url("<?php echo e(asset('assets/images/login_bg.jpg')); ?>");
        }
        ...
        .contact-bg{
            ...
            background-position: center center !important;
            z-index: 2 !important;
            background: url("<?php echo e(asset('assets/images/contact.jpg')); ?>");
        }
        ...
        .footer {
                background: linear-gradient(
                    ...
                    url("<?php echo e(asset('assets/images/footer_bg.jpg')); ?>");
                position: relative;
                z-index: 1;
                background-size: cover;
                background-repeat: no-repeat;
        ...
        .testimonial-section {
            ...
            background: linear-gradient(90deg, var(--primary-light), var(--primary-light)),
                  url("<?php echo e(asset('assets/images/testimonial.jpg')); ?>");
            background-size: cover;
            background-repeat: no-repeat;
        ...
        .title-left-content > h3::after {
            content: url("<?php echo e(asset('assets/images/title-vector.png')); ?>");
            position: absolute;
            right: 0px;
...
<body>
    ...
    <?php if(site_settings('preloader') ==  App\Enums\StatusEnum::true->status()): ?>

        <div class="preloader-wrapper">
            <canvas id="bg"></canvas>
            <div class="loader-content">
                <div class="loader-img scale-up-center">
                    <img src="<?php echo e(show_image('assets/images/backend/logoIcon/'.site_settings('site_logo'), file_path()['site_logo']['size'])); ?>" alt="site-logo.jpg" class="img-fluid">
                </div>
            </div>
        </div>
    ...
    <?php if(!session()->has('dont_show')): ?>
        <?php echo $__env->renderWhen($news_latter->status == '1','frontend.partials.newsLatter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path'])); ?>
    <?php endif; ?>

    <main>
        <?php echo $__env->yieldContent('content'); ?>

        <?php echo $__env->renderWhen($news_latter->status == '1', 'frontend.section.news_later', ['news_latter' => $news_latter], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path'])); ?>
        ...
        <?php if(site_settings("whats_app_plugin")  ==  App\Enums\StatusEnum::true->status()): ?>
            <div class="wp-floating-btn">
                <a href="https://wa.me/<?php echo e(site_settings("whats_app_number")); ?>?text=<?php echo e(site_settings('whats_app_number_int_message')); ?>" target="_blank">
                    <span class="wp-icon">
        ...
        <?php if( $cookie->status == '1'  && !session()->has('cookie_consent') ): ?>
     ...
     <script>
        ...
        function social_share(title, w, h) {
            ...
            if(!price){
                price  = "<?php echo e(show_currency()); ?>"+$("#total").text();
            }
        ...
        <?php if(isset($tawkTo['widget_id'])): ?>
                var status = "<?php echo e($tawkTo['status']); ?>"
                var widget_id = "<?php echo e($tawkTo['widget_id']); ?>"
                var property_id = "<?php echo e($tawkTo['property_id']); ?>"
        ...
        if (newsLetterModal != null && currentRoute == 'home') {
         ...
         $(function(){
             $(document).on('click', '.modal-closer',function(e){
                 ...
                 if(check){
                     $.ajax({
                         ...
                         type: "POST",
                         url: "<?php echo e(route('newslatter.close')); ?>",
                         dataType: "json",
            ...
            $(document).on('click','.attribute-select',function(e){
                    ...
                    $.ajax({
                            headers: {"X-CSRF-TOKEN": "<?php echo e(csrf_token()); ?>",},
                            url: "<?php echo e(route('product.stock.price')); ?>",
                            method: "post",
                            data: data,
                            processData: false,
                            contentType: false,
                            success: function (response) {
                                ...
                                const currencySymbol = '<?php echo e(show_currency()); ?>';
      ...
      $(document).on('click','.cookie-control',function(e){
            ...
            $.ajax({
                method:'get',
                url: "<?php echo e(route('accept.cookie')); ?>",
                dataType: 'json',
...
<?php /**PATH /home/u935716083/domains/testlinkdesigns.com/public_html/zelor/resources/views/frontend/layouts/app.blade.php ENDPATH**/ ?>
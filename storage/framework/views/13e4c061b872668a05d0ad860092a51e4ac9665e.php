   <section class="testimonial-section pt-80 pb-80" style="background:#404040;">
        <div class="Container">
            <div class="row justify-content-center gy-4">
                <div class="col-lg-6 pe-lg-5">
                    ...
                    <div class="section-big-title">
                        ...
                        <h2 style="color: white;"> <?php echo e(@frontend_section_data($testimonial_section->value,'title')); ?></h2>
                        <p  style="color: white;" class="mb-5"><?php echo e(@frontend_section_data($testimonial_section->value,'description')); ?>.</p>
                    </div>
                    ...
                    <div class="col-lg-6 position-relative">
                                ...
                                <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="swiper-slide">
                                        <div class="testimonial-single">
                                            <div class="ratting">
                                                <?php echo  show_ratings($testimonial->rating) ?>
                                            </div>
                                            <p><?php echo e(limit_words($testimonial->quote,23)); ?></p>
                                            <div class="testi-author">
                                                <div class="image">
                                                    <img src="<?php echo e(show_image(file_path()['testimonial']['path'].'/'.$testimonial->image,file_path()['testimonial']['size'])); ?>" alt="<?php echo e($testimonial->image); ?>">
                                                </div>
                                                <div class="content">
                        ...
                        <div class="testi-rating">
                            ...
                            <div class="content">
                                ...
                                <h3><?php echo e(round($testimonials->avg('rating'))); ?> / 5</h3>
                                <div class="ratting">
                                    <?php echo  show_ratings($testimonials->avg('rating')) ?>
                                </div>
                                <p><?php echo e($testimonials->count()); ?> <?php echo e(translate('Customer review')); ?></p>
                            </div>
                        </div>
                    </div>
                <?php else: ?>
...
<?php /**PATH /home/u935716083/domains/testlinkdesigns.com/public_html/zelor/resources/views/frontend/section/testimonial.blade.php ENDPATH**/ ?>
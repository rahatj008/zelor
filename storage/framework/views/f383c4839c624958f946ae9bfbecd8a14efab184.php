        ...
        <div class="row">
            <div class="col-lg-7 order-2">
                <div class="newsletter-left">
                    <h2><?php echo e(@frontend_section_data($news_latter->value,'heading')); ?> </h2>
                    <span><?php echo e(@frontend_section_data($news_latter->value,'sub_heading')); ?></span>
                    <form   method="post" action="<?php echo e(route('newslatter.subscribe')); ?>" class="newsletter-form">
                        <?php echo csrf_field(); ?>
                        <div class="newsletter-form-input">
                            <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Enter your email address" class="newsletter-email">
            ...
            <div class="col-lg-5 d-flex justify-content-lg-start justify-content-start order-1">
                <div class="need-help">
                    ...
                    <div class="content">
                        ...
                        <p>
                            <?php echo e(translate('Need Help ? Call Now')); ?>
...
<?php /**PATH /home/u935716083/domains/testlinkdesigns.com/public_html/zelor/resources/views/frontend/section/news_later.blade.php ENDPATH**/ ?>
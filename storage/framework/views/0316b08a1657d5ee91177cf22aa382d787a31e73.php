...
<div class="header-middle" style="background:#404040;">
        ...
        <div class="header-middle-container">
            <div class="middle-left">
                ...
                <div class="lang-dropdown middle-left-item">
                    <div class="Dropdown">
                         <button class="dropdown__button" type="button" style="color: white;"><?php echo e($lang->first()->name); ?>
                ...
                <div class="currency-dropdown middle-left-item">
                    ...
                    ?>
                    <div class="Dropdown">
                        <button class="dropdown__button" type="button" style="color: white;">
                        ...
                        <ul class="dropdown__list">
                            <?php $__currentLoopData = $currencys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="chanage_currency dropdown__list-item" data-value="<?php echo e($currency->id); ?>"><?php echo e($currency->name); ?></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <a href="tel:<?php echo e(site_settings('phone')); ?>" class="header-contact middle-left-item">
                    <div class="header-contact-number">
                        <small style="color: white;">
                            <?php echo e(translate("Need Help?")); ?>

                        </small>
                        <span style="color: white;">
                            <?php echo e(site_settings('phone')); ?>
            ...
            <div class="middle-right mobile-menu">
                <nav class="navBar">
                    ...
                    <a href="<?php echo e(route('cart.view')); ?>" class="d-lg-none">
                    ...
                    <?php if($support->status =='1'): ?>
                        ...
                        <svg viewBox="-2.4 -2.4 28.80 28.80" role="img" xmlns="http://www.w3.org/2000/svg" aria-labelledby="supportIconTitle"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="none" color="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"  stroke-width="0.192"></g><g id="SVGRepo_iconCarrier"> <title id="supportIconTitle">Support</title> <path d="M18,9 L16,9 C14.8954305,9 14,9.8954305 14,11 L14,13 C14,14.1045695 14.8954305,15 16,15 L16,15 C17.1045695,15 18,14.1045695 18,13 L18,9 C18,4.02943725 13.9705627,0 9,0 C4.02943725,0 0,4.02943725 0,9 L0,13 C1.3527075e-16,14.1045695 0.8954305,15 2,15 L2,15 C3.1045695,15 4,14.1045695 4,13 L4,11 C4,9.8954305 3.1045695,9 2,9 L0,9" transform="translate(3 3)"></path> <path d="M21,14 L21,18 C21,20 20.3333333,21 19,21 C17.6666667,21 16,21 14,21"></path> </g></svg>
                            <span style="color: white;"><?php echo e(translate("Support")); ?></span>
                        </a>
                    <?php endif; ?>

                    <?php if($contact->status =='1'): ?>
                        <a  href="<?php echo e(route('contact')); ?>" role="button">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <?php if(site_settings('multi_vendor',App\Enums\StatusEnum::true->status()) ==  App\Enums\StatusEnum::true->status()): ?>
                        ...
                        <a href="<?php echo e(route('seller.register')); ?>"  class="d-lg-flex d-none">
                    ...
                    <a href="<?php echo e(route('user.track.order')); ?>" class="d-lg-flex d-none">
                        <span style="color: white;">
                    ...
                    <?php if(!auth_user('web')): ?>
                        <a href="<?php echo e(route("login")); ?>" class="login-sidebar">
...
<header class="sticky">
    <div class="header-bottom" style="background:#404040;">
        <div class="container-fluid">
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-3">
                        <form   method="GET" class="search-bar w-100">
                            <div class="live-search-input">
                                <div class="search" style="background:#404040;">
                                  <i class="fa fa-search"></i>
                                  <input id="search-text" type="search" placeholder="<?php echo e(translate('What are you looking for?')); ?>" name="search" value=""  class="form-control">
                                </div>
                ...
                <div class="header-action d-none d-md-none d-lg-flex">
                    <div class="header-action-item">
                        <div class="header-action-container">
                            <a href="<?php echo e(route('user.wishlist.item')); ?>" class="each-action-item d-lg-flex d-none">
                                ...
                                <div class="d-flex flex-column" style="color:white !important;">
                                    <span class="each-action-item-sub" style="color:white !important;"><?php echo e(translate('Favorite')); ?></span>
                        ...
                        <div class="header-action-container">
                            <a href="<?php echo e(route('compare')); ?>" class="each-action-item d-lg-flex d-none">
                                <div class="position-relative">
                                    <div class="header-action-icon">
                                ...
                                <div class="d-flex flex-column" style="color:white !important;">
                                    <span class="each-action-item-sub" style="color:white !important;"><?php echo e(translate('Compare')); ?></span>
                                    <?php echo e(translate('Compare list')); ?>
                        ...
                        <div class="header-action-container">
                            <div class="each-action-item d-lg-flex d-none">
                                ...
                                <div class="d-flex flex-column" style="color:white !important;">
                                    <span class="each-action-item-sub" style="color:white !important;"><?php echo e(translate('Your Cart:')); ?></span>
    ...
    <?php echo $__env->make('frontend.partials.md_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</header>
...
<?php /**PATH /home/u935716083/domains/testlinkdesigns.com/public_html/zelor/resources/views/frontend/partials/header.blade.php ENDPATH**/ ?>
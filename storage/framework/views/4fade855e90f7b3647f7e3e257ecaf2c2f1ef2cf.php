        ...
        <div class="section-title">
            <div class="section-title-left">
                <div class="title-left-content">
                    <h3 style="color: white;"><?php echo e(@frontend_section_data($new_arrival->value,'heading')); ?> </h3>
                    <p style="color: white;"><?php echo e(@frontend_section_data($new_arrival->value,'sub_heading')); ?></p>
                </div>
            </div>
            <div class="section-title-right">
                <a href="<?php echo e(route('new.product')); ?>" class="view-more-btn" style="color: white !important;border: 0.1rem solid white !important;">
                                    ...
                                    <div class="product-img">
                                     ...
                                     <div class="product-info">
                                        ...
                                        <div class="product-action">
                                            ...
                                            <button data-product_id ="<?php echo e($product->id); ?>" class="heart-btn wishlistitem"><i class="
                                                <?php if(in_array($product->id,$wishedProducts)): ?>
                                                    fa-solid
                                                <?php else: ?>
                                                    fa-regular
                                                <?php endif; ?>
...
<?php if( @frontend_section_data($promo_banner->value,'position') == 'new-arrivals'): ?>
...
<?php if( @frontend_section_data($promo_second_banner->value,'position') == 'new-arrivals'): ?>
...
<?php endif; ?>
<?php /**PATH /home/u935716083/domains/testlinkdesigns.com/public_html/zelor/resources/views/frontend/section/new_product.blade.php ENDPATH**/ ?>
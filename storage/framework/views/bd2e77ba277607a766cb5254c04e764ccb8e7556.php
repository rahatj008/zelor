            ...
            <div class="card" id="orderList">
                ...
                <div class="card-body pt-0">
                    <ul class="nav nav-tabs nav-tabs-custom nav-primary mb-3" role="tablist">
                        <li class="nav-item">
                            <a class='nav-link <?php echo e(request()->routeIs('seller.order.index') ? 'active' : ''); ?> All py-3'
                                id="All" href="<?php echo e(route('seller.order.index')); ?>">
                        ...
                        <li class="nav-item">
                            <a class='nav-link <?php echo e(request()->routeIs('seller.order.pending') ? 'active' : ''); ?>  Placed py-3'
                                id="pending" href="<?php echo e(route('seller.order.pending')); ?>">
                        ...
                        <li class="nav-item">
                            <a class='nav-link <?php echo e(request()->routeIs('seller.order.placed') ? 'active' : ''); ?>  Placed py-3'
                                id="Placed" href="<?php echo e(route('seller.order.placed')); ?>">
                        ...
                        <li class="nav-item">
                            <a class='nav-link <?php echo e(request()->routeIs('seller.order.confirmed') ? 'active' : ''); ?> Confirmed py-3'
                                id="Confirmed" href="<?php echo e(route('seller.order.confirmed')); ?>">
                        ...
                        <li class="nav-item">
                            <a class='nav-link Processing <?php echo e(request()->routeIs('seller.order.processing') ? 'active' : ''); ?>   py-3'
                                id="Processing" href="<?php echo e(route('seller.order.processing')); ?>">
                        ...
                        <li class="nav-item">
                            <a class='nav-link Shipped <?php echo e(request()->routeIs('seller.order.shipped') ? 'active' : ''); ?>   py-3'
                                id="Shipped" href="<?php echo e(route('seller.order.shipped')); ?>">
                        ...
                        <li class="nav-item">
                            <a class='nav-link py-3 <?php echo e(request()->routeIs('seller.order.delivered') ? 'active' : ''); ?>   Delivered'
                                id="Delivered" href="<?php echo e(route('seller.order.delivered')); ?>">
                        ...
                        <li class="nav-item">
                            <a class='nav-link <?php echo e(request()->routeIs('seller.order.cancel') ? 'active' : ''); ?>   py-3 Returns'
                                id="Returns" href="<?php echo e(route('seller.order.cancel')); ?>">
                        ...
                        <li class="nav-item">
                            <a class='nav-link <?php echo e(request()->routeIs('seller.order.return') ? 'active' : ''); ?>   py-3 Returns'
                                id="Returns" href="<?php echo e(route('seller.order.return')); ?>">
                        ...
                        <table class="table table-hover table-nowrap align-middle mb-0">
                            <thead class="text-muted table-light">
                                <tr class="text-uppercase">
                                    ...
                                    <th>
                                        <?php echo e(translate('Product Detail')); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="<?php echo e(translate('Order Number')); ?>">
                                            ...
                                            <a data-bs-toggle="tooltip" data-bs-placement="top" title="Order Number"
                                                href="<?php echo e(route('seller.order.details', $order->id)); ?>">
                                        ...
                                        <td data-label="<?php echo e(translate('Customer Info')); ?>" class="text-align-left">
                                            ...
                                            <span>
                                                ...
                                                :
                                                <?php echo e(@$order->customer->email ?? @$email); ?></span>
                                            <br>
                                        ...
                                        <td data-label="<?php echo e(translate('Product Name')); ?>" class="tex-align-left">
                                        ...
                                        <td data-label="<?php echo e(translate('Amount')); ?>">
                                            ...
                                            ?>
                                            <span class="fw-bold">
                                                <?php echo e(short_amount($totalAmount)); ?></span><br>
                                        ...
                                        <td data-label="<?php echo e(translate('Action')); ?>">
                                            ...
                                            <div class="hstack justify-content-center gap-3">
                                                <a title="Print" data-bs-toggle="tooltip" data-bs-placement="top"
                                                    href="<?php echo e(route('seller.order.print', [$order->id])); ?>"
...
<?php echo $__env->make('seller.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u935716083/domains/testlinkdesigns.com/public_html/zelor/resources/views/seller/order/index.blade.php ENDPATH**/ ?>
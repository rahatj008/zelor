                ...
                <div class="Container">
                    <div class="section-title">
                        <div class="section-title-left">
                            <div class="title-left-content">
                                <h3 style="color: white;"><?php echo e(@get_translation($category->category->name)); ?></h3>
                                <p style="color: white;"><?php echo e($category->title ?  $category->title :@frontend_section_data($menu_category_section->value,'sub_heading')); ?></p>
                            </div>
                        </div>
                        <div class="section-title-right">
                                <a href="<?php echo e(route('category.product', [$category->category->slug ? $category->category->slug :   make_slug(get_translation($category->category->name)),$category->category_id])); ?>" class="view-more-btn" style="color: white !important;border: 0.1rem solid white !important;">
                    ...
                    <div class="individual-categories-items">
                        <div class="slider-container">
                            ...
                            <div class="swiper individual-categories-slider-<?php echo e($category->id); ?> swiper-container">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="product-item">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <h4 class="product-title"> <a href="<?php echo e(route('product.details',[$product->slug ? $product->slug : make_slug($product->name),$product->id])); ?>"><?php echo e($product->name); ?></a></h4>
                            ...
                            <button class="prev next-prev-btn prev-cate-<?php echo e($category->id); ?>">
                                <i class="fa-solid fa-arrow-left"></i>
                            </button>
                            <button class="next next-prev-btn next-cate-<?php echo e($category->id); ?>">
...
<?php if(@frontend_section_data($promo_banner->value,'position') == 'menu-category'): ?>
...
<?php if(@frontend_section_data($promo_second_banner->value,'position') == 'menu-category'): ?>
...
"use strict"
   ...
   var categories = <?php echo json_encode($categoryId, 15, 512) ?>;
...
<?php /**PATH /home/u935716083/domains/testlinkdesigns.com/public_html/zelor/resources/views/frontend/section/menu_category.blade.php ENDPATH**/ ?>
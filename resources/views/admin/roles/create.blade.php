                    ...
                    <div class="mt-3">
                        ...
                        <div class="row g-3">
                            @foreach ($permissions as $permission)
                                @if(any_permission_check($permission))
                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="d-flex align-items-center justify-content-between gap-3 form-control p-2">
                                                                ...
                                                                <div class="form-check form-switch">
                                                                    <input type="checkbox" value="{{$module}}" name="permission[{{$key}}][{{$module}}] "  class="form-check-input" id="{{$module}}" >

<div class="app-menu navbar-menu">
    ...
    <div id="scrollbar" class="scroll-bar" data-simplebar>
        ...
        {{-- <div class="pt-3">
            <input type="search" name="search" class="form-control bg-transparent text-light search-menu-input"
            ...
            <ul class="navbar-nav" id="navbar-nav">
                                ...
                                @if(permission_check('manage_taxes'))
                                    <li class="nav-item">
                                        <a href="{{route('admin.tax.list')}}"
                                            class="{{request()->routeIs('admin.tax.*') ? 'active' : '' }}  nav-link">
                                            {{translate("Tax")}}
                                        </a>
                                    </li>
                                @endif
                ...
                @if(permission_check('view_support'))
                    ...
                    ''    }}" href="#userReport" data-bs-toggle="collapse" role="button" aria-expanded="false"
                                ...
                                <div class="pt-1 collapse  {{request()->routeIs('admin.report.*') || request()->routeIs('admin.payment.index') || request()->routeIs('admin.payment.*') || request()->routeIs('admin.deposit.*') || request()->routeIs('admin.withdraw.log.*') ? 'show' : ''   }}   menu-dropdown"
                                    id="userReport">
                                    <ul class="nav nav-sm flex-column gap-1">
                ...
                @if(permission_check('view_system_settings'))
                                ...
                                <ul class="nav nav-sm flex-column gap-1">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('admin.general.setting.kyc')}}"
                                            class="{{request()->routeIs('admin.general.setting.kyc') ? 'active' : ''}}   nav-link">
                                                ...
                                                <ul class="nav nav-sm flex-column gap-1">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="{{route('admin.shipping.configuration.index')}}"
                                                            class=" {{request()->routeIs('admin.shipping.configuration.*') ? 'active' : ''  }}  nav-link">
                                                            {{translate('Configuration')}}
                                                        </a>
                                                    </li>
                                                    ...
                                                    @if(permission_check('manage_countries'))
                                                        <li class="nav-item">
                                                            <a href="{{route('admin.shipping.country.index')}}"
                                                                class=" {{request()->routeIs('admin.shipping.country.*') ? 'active' : ''  }}  nav-link">
                                                    ...
                                                    @if(permission_check('manage_states'))
                                                        <li class="nav-item">
                                                            <a href="{{route('admin.shipping.state.index')}}"
                                                                class=" {{request()->routeIs('admin.shipping.state.*') ? 'active' : ''  }}  nav-link">
                                                    ...
                                                    @if(permission_check('manage_cities'))
                                                        <li class="nav-item">
                                                            <a href="{{route('admin.shipping.city.index')}}"
                                                                class=" {{request()->routeIs('admin.shipping.city.*') ? 'active' : ''  }}  nav-link">
                                                    ...
                                                    @if(permission_check('manage_zones'))
                                                        <li class="nav-item">
                                                            <a href="{{route('admin.shipping.zone.index')}}"
                                                                class=" {{request()->routeIs('admin.shipping.zone.*') ? 'active' : ''  }}  nav-link">

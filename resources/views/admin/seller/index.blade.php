                            ...
                            @forelse($sellers as $seller)
                                <tr>
                                    ...
                                    <td data-label="{{translate('Products')}}">
                                        <a  data-bs-toggle="tooltip" data-bs-placement="top" title="{{translate('View physical product')}}" class="ms-2 badge text-bg-primary custom-toggle active"  href="{{route('admin.product.seller.index', ['seller_id' => $seller->id])}}" >{{translate('Product')}} ({{$seller->product->wherenull('deleted_at')->where('product_type', 102)->count()}})</a>
                                        <!----->

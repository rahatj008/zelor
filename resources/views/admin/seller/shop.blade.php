					...
					<div class="card-body p-4">
						...
						<div class="p-3 bg-body rounded">
                            ...
                            <ul class="list-group">
                                ...
                                <li class="d-flex justify-content-between align-items-center flex-wrap gap-2 list-group-item">
                                    <span class="fw-semibold">
                                        {{translate('Google Map Link')}}
                                    </span>
									@if(@$seller->sellerShop->maplink)
                                    <a href="{{@$seller->sellerShop->maplink}}" target="_blank" class="font-weight-bold">View in google map</a>
									@else
										{{ translate('N/A') }}
                                    @endif
                                </li>
						...
						<form action="{{route('admin.seller.info.shop.update', $seller->id)}}" method="POST" enctype="multipart/form-data">
							...
							<div class="border rounded p-3">
								...
								<div class="row g-4">
									...
									<div class="col-lg-12">
										<label for="maplink" class="form-label">{{translate('Shop Google Map Link')}}</label>
										<input type="text" name="maplink" id="maplink" value="{{@$shopSetting->maplink}}" class="form-control" placeholder="{{translate('Enter shop google map link')}}">
									</div>

                    ...
                    <div class="section-title">
                        <div class="section-title-left">
                            <div class="title-left-content">
                                ...
                                <p style="color: white;">{{  $category->title ?  $category->title :@frontend_section_data($menu_category_section->value,'sub_heading')}}</p>
                            </div>
                        </div>
                        <div class="section-title-right">
                                <a href="{{{route('category.product', [$category->category->slug ? $category->category->slug :   make_slug(get_translation($category->category->name)),$category->category_id])}}}" class="view-more-btn" style="color: white !important;border: 0.1rem solid white !important;">
                                    {{translate('View More')}}
                                </a>
                        </div>
                    </div>

        ...
        <div class="section-title">
            <div class="section-title-left">
                <div class="title-left-content">
                    <h3 style="color: white;">{{@frontend_section_data($top_brands_sections->value,'heading')}} </h3>
                    <p style="color: white;">{{@frontend_section_data($top_brands_sections->value,'sub_heading')}}</p>
                </div>
            </div>
            <div class="section-title-right">
              <a href="{{route('top.brand')}}" class="view-more-btn" style="color: white !important;border: 0.1rem solid white !important;">
                   {{translate("View More")}}
                </a>
            </div>
        </div>
        ...
        <div class="row g-2 g-sm-4">
            @forelse($brands->take(12) as $brand)
                <div class="col-xxl-2 col-xl-3 col-md-4 col-sm-6">
                    <a href="{{route('brand.product', [ $brand->slug ? $brand->slug :  make_slug(get_translation($brand->name)), $brand->id])}}" class="brand-item">

        ...
        <div class="section-title">
            <div class="section-title-left">
                <div class="title-left-content">
                    <h3 style="color: white;">{{@frontend_section_data($top_category->value,'heading')}} </h3>
                    <p style="color: white;">{{@frontend_section_data($top_category->value,'sub_heading')}}</p>
                </div>
            </div>
            <div class="section-title-right d-flex flex-row align-items-center gap-4">
                <a href="{{route('top.category')}}" class="view-more-btn" style="color: white !important;border: 0.1rem solid white !important;">{{translate("View More")}} </a>
            </div>
        </div>
                ...
                <div class="swiper-wrapper">
                    @forelse($top_categories  as $category)
                        <div class="swiper-slide">
                            <a href="{{route('category.product', [ $category->slug ? $category->slug : make_slug(get_translation($category->name)), $category->id])}}" class="categorie-item">

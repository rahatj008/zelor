        ...
        <div class="section-title">
            <div class="section-title-left">
                <div class="title-left-content">
                    <h3 style="color: white;">{{@frontend_section_data($new_arrival->value,'heading')}} </h3>
                    <p style="color: white;">{{@frontend_section_data($new_arrival->value,'sub_heading')}}</p>
                </div>
            </div>
            <div class="section-title-right">
                <a href="{{route('new.product')}}" class="view-more-btn" style="color: white !important;border: 0.1rem solid white !important;">
                    {{translate("View More")}}
                 </a>
            </div>
        </div>

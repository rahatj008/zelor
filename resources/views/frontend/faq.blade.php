...
<section class="faq-section" style="background:#404040 !important; padding: 5rem 2rem !important;">
        ...
        <div class="Container">
            <div class="sidebar-support-container">
                <div class="row g-4 justify-content-start align-items-center mb-40">
                    <div class="col-lg-9">
                        <div class="title-left-content">
                            <h3 class="text-white">{{@frontend_section_data($support->value,'heading')}}</h3>
                            <p class="text-white">{{@frontend_section_data($support->value,'sub_heading')}}</p>
                        </div>
                    </div>
                ...
                <h4 class="text-white">{{translate('Frequently asked questions')}}</h4>
                <div class="faqs-tab">

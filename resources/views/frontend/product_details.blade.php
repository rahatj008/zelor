            ...
            <div class="product-detail-middle">
                ...
                <div class="product-item-review">
                    <div class="ratting mb-0">
                        ...
                        <small class="text-white" >({{$product->review->count()}} {{translate('Review')}})</small>
                    </div>
                    <small style="color: #fff !important">{{$product->order->count()}}
                        {{translate('Orders')}}
                    </small>
                </div>
                    ...
                    <div class="card-header" style="background: #671E1F !important;"  >
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <h4 class="card-title mb-0 text-white">{{translate("Related Product")}}</h4>
                            </div>
                            <div>

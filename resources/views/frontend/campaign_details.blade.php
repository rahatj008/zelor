...
<div class="campaign-full-banner w-100 p-0">
    <img class="w-100" src="{{show_image(file_path()['campaign_banner']['path'].'/'.$campaign->banner_image,file_path()['campaign_banner']['size'])}}" alt="{{@$campaign->banner_image}}">
</div>
...
<section class="pt-80 pb-80" style="background: #404040 !important">
    <div class="Container">
        <div class="title-with-tab section-title">
            <div class="section-title-left align-items-center flex-row justify-content-between w-100">
                <div class="title-left-content">
                    <h3 style="color: #fff !important">{{$campaign->name}}</h3>
                </div>
